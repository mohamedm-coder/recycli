  ...
  <div class="dropdown-menu">
    ...
    <div class="row">
      <div class="col-lg-12 col-sm-12 col-12 texte center chekout">
        <a href="{{url('cart')}}" class="btn">عرض الكل </a>
      </div>
    </div>
</div>
  </div>
...
<div class="col-lg-3 col-md-6 col-sm-6 d-flex">
  <div class="card w-100 my-2 shadow-2-strong">
    <img src="user/images/faces/téléchargement (2).jpg" class="card-img-top" style="aspect-ratio: 1 / 1" />
...
<div class="col-lg-3 col-md-6 col-sm-6 d-flex">
  <div class="card w-100 my-2 shadow-2-strong">
    <img src="user/images/faces/téléchargement (1).jpg" class="card-img-top" style="aspect-ratio: 1 / 1" />
...
<div class="col-lg-3 col-md-6 col-sm-6 d-flex">
  <div class="card w-100 my-2 shadow-2-strong">
    <img src="user/images/faces/téléchargement (3).jpg" class="card-img-top" style="aspect-ratio: 1 / 1" />
...
<div class="col-lg-3 col-md-6 col-sm-6 d-flex">
  <div class="card w-100 my-2 shadow-2-strong">
    <img src="user/images/faces/téléchargement.jpg" class="card-img-top" style="aspect-ratio: 1 / 1" />
